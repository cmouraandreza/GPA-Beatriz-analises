...
V(g)$group <- ifelse(V(g)$type, "familia", "genero")
...
#========================
# 8) LAYOUT RADIAL - FAMÍLIAS NA PERIFERIA (melhorado)
#    espécies em múltiplos anéis para espaçar mais
#========================
set.seed(42)
...
# Ajuste para melhorar distribuição (opcional - descomente se quiser)
# Adiciona pequena repulsão para evitar sobreposição
# set.seed(42)
# lay <- layout_with_fr(g, niter = 300, coords = lay, 
#                       area = vcount(g)^2, repulserad = vcount(g)^2.5)
...
#familia grau strength
# Hebellidae       Hebellidae    1        1
# Stylasteridae Stylasteridae    1        1
# Tiarannidae     Tiarannidae    1        1
# Oceaniidae       Oceaniidae    1        1
...
# layout forçado para material suplementar----- nao usar -----
...
# (opcional) expande um pouco o layout (mais espaço entre nós)
lay_fr <- lay_fr * 1.3
